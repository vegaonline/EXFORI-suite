    ...
    public void setRowFactory() {
        editTable.setRowFactory ((TableView<editableData> tv) -> {
            ...
            row.setOnMouseClicked ((MouseEvent event) -> {
                ...
                int rowCnt = 1;
                //########################################################## check
                tmp4 = (clickedRow != null) ? clickedRow.bibItemNameProperty ().
                        getValue () : "";
                    ...
                    if ( !isSelect ) {
                        ...
                        if ( act.contains ("Edit") ) {
                            for ( int ii = 0; ii < multiLine; ii++ ) {
                                ...
                                if ( tmpINT == multiLine ) {
                                    myData.set (ri + ii,
                                            new editableData (tmpHead, "", strEntered, SE));
                                } else {
                                    myData.set (ri + ii,
                                            new editableData (tmpHead, "", strEntered, SE));
                                    ++myDataN;
                                ...
                                if ( ii <= multiLine - 2 ) {
                                    parseStr = parseStr.substring (2 + parseStr. indexOf ("@@"));
                                }
                            }
                        } else {
                            for ( int ii = 0; ii < multiLine; ii++ ) {
                                ...
                                // if ( ii < multiLine - 1 ) {
                                if ( ii <= multiLine - 2 ) {
                                    strEntered = parseStr.substring (0, parseStr.indexOf ("@@"));
                                } else {
                                    strEntered = parseStr;
                                }
