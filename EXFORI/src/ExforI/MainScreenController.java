...
//FXML stuffs
    ...
    public void setlibList(libList lList) {
        this.lList = lList;
        System.out.println("SEQ:->  In setLibList"+lList.rptList);
    }
    ...
    private void doSelfCheck(ActionEvent event) throws InterruptedException,
        ...
        if ( !entryNum.isEmpty () &&
                 ...
                 !myData.isEmpty () &&
                 isOrdered ) {
            selfChecker.selfChecker (entryNum, fName, myData, brW, lList);
        }
    }
    ...
    public void initialize() {
        ...
        setupOS ();
        System.out.println (" In main Initialize-> " + lList.targetNList.size ());
        System.exit(0);
...
//@SuppressWarnings ("unchecked")
    ...
    public void startProcess() {
        ...
        System.out.println("SEQ:->  In StartProcess B4 entryChoice");
        System.out.println("Target size in MAIN->"+lList.targetNList.size ());
        // Institute related
        entryChoice (lList.instList, institute);
