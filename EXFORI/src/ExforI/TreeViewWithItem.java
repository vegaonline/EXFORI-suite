 ...
 * @author vega
 */
public class TreeViewWithItem <T extends HierarchyData<T>> extends TreeView<T> {
    ...
    private final Map<TreeItem<T>, ListChangeListener<T>> hardReferences = 
            new HashMap<TreeItem<T>, ListChangeListener<T>>();
     ...
     */
    public TreeViewWithItem(TreeItem<T> root) {
        super(root);
        init();
    }
